...
1. **Initialize Project:**
    ...
    * git init
    * Create .gitignore (add node\_modules, dist, .env, bun.lockb)
...
this.config \= {  
...config,  
baseUrl: config.baseUrl || '\[https://porkbun.com/api/json/v3\](https://porkbun.com/api/json/v3)',  
};
...
const config \= { apiKey: 'pk\_test', secretApiKey: 'sk\_test' };
...
const mockResponse \= { status: 'SUCCESS', yourIp: ip };
    ...
    mock.onPost('\[https://porkbun.com/api/json/v3/ping').reply(200\](https://porkbun.com/api/json/v3/ping').reply(200), mockResponse);  
...
mock.onPost('\[https://porkbun.com/api/json/v3/domain/pricing').reply(200\](https://porkbun.com/api/json/v3/domain/pricing').reply(200), mockResponse);
